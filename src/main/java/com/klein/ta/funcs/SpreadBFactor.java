 ...
 */
public class SpreadBFactor extends AbstractTaFunction {
    ...
    public SpreadBFactor(Series series) {
        super(series);
    ...
    protected String getKey() {
        return "spreadb_" + period + "_" + base1.getKey() + "_" + base2.getKey();
    }

    @Override
    public String getShortName() {
        return "Spread B Factor";
    }
...
//                    System.out.println(x[i] + "\t" + y[i][0]);
                ...
                data[n] = ols.estimateRegressionParameters()[0];
            } else {
                data[n] = -1D;
            }
        }
